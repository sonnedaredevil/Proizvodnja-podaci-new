...
def _dark_fig(fig, title=None, height=420):
    fig.update_layout(
        ...
        height=height,
        paper_bgcolor="rgba(0,0,0,0)",
        plot_bgcolor="rgba(2,6,23,0.80)",
        font=dict(color="#E5E7EB"),
        margin=dict(l=35, r=25, t=70 if title else 25, b=55),
        hoverlabel=dict(bgcolor="#020617", font_color="#F8FAFC", bordercolor="#38BDF8"),
    )
    fig.update_xaxes(gridcolor="rgba(148,163,184,0.16)", zerolinecolor="rgba(148,163,184,0.20)")
    fig.update_yaxes(gridcolor="rgba(148,163,184,0.16)", zerolinecolor="rgba(148,163,184,0.20)")
    return fig
